...
def main():
    print('19 -', min([x for x in range(2, HEAP_SIZE) if is_win(5, x, 1)]))
    print('20 -', [x for x in range(2, HEAP_SIZE) if not is_win(5, x, 1) and is_win(5, x, 3)])
    print('21 -', min([x for x in range(2, HEAP_SIZE) if not is_win(5, x, 2) and is_win(5, x, 4)]))
